...
void main() {
  ...
  // Imprime la energía restante después de intentar cargar un teléfono con la planta eólica.
  print('wind: ${chargePhone(windPlant)}');
}

// Función que simula la carga de un teléfono consumiendo 10 unidades de energía de una planta.
...
// Enumeración que define los tipos de plantas energéticas disponibles.
enum PlantType { nuclear, wind, water }

// Clase abstracta que define la estructura básica para una planta de energía.
abstract class EnergyPlant {
  // Almacena la cantidad de energía restante en la planta.
  double energyLeft;
  // Tipo de planta de energía, definido por el enum PlantType.
  ...
  // Método abstracto que define cómo se debe consumir energía en las subclases.
